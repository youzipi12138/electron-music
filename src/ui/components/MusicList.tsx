        ...
        {musicList.map((pl, idx) => (
          ...
          >
            <div className='w-full aspect-square relative'>
              ...
              <div className='absolute top-2 right-2 flex items-center gap-1 text-white text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity'>
                <Play size={14} className='text-white ml-1' fill='white' />
                <span>{formatPlayCount(pl.playCount)}</span>
              </div>
              {/* <button
                aria-label='Play'
